...
export const SERVICES: Service[] = [
  {
    ...
    highlights: [
      ...
      'Direct transfer between the airport and our dive center or your hotel',
      'Comfortable space for you and all your dive equipment',
    ],
    price: '$40 per way',
  ...
  },
  {
    ...
    highlights: [
      'Fully customized private expedition itinerary',
      'Ideal for groups and families',
      'Well suited to professional underwater photography and videography projects',
    ],
    price: 'From $800 / Day',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Experienced guides lead every trip',
      'Visit pristine shallow reefs',
      'Premium snorkeling gear and refreshments included',
    ],
    price: '$35 per person',
  ...
  },
  {
    ...
    highlights: [
      'Certified underwater photographer accompanies your dive',
      'Professional equipment and technique',
      'High-resolution, edited digital images delivered after your dive',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Fresh tropical fruits, snacks, and mineral water included on every trip',
      'Optional premium lunch upgrade',
      'Hot meals prepared fresh on board',
    ],
