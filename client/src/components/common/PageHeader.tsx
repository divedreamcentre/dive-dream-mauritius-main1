interface PageHeaderProps {
  ...
  /** Optional background photo behind the title, same treatment as DiveSafaris.tsx's header. */
  image?: string;
}
...
export function PageHeader({ eyebrow, title, description, paddingClassName = 'py-24', image }: PageHeaderProps) {
  return (
    <section className={`relative border-b border-border overflow-hidden ${paddingClassName}`}>
      {image && (
